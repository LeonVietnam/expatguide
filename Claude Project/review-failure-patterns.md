...
**修复成功示例**(trc-renewal-guide-2026 patch 后):

"The 30-day passport-buffer rule is grounded in Law No. 47/2014/QH13 on entry, exit, transit, and residence of foreigners in Vietnam, effective from 1 January 2015, as amended by Law No. 51/2019/QH14 and Law No. 23/2023/QH15. Article 38 of the current consolidated framework states that a TRC must be at least 30 days shorter than the remaining passport validity."

句式要点:

- 上位法 + 修正案链 同时具名(全名 + 编号 + 生效日 三件套)
- 具体条款编号(Article 38)优于仅给上位法
- "the current consolidated framework"措辞处理多次修正后的现行文本,避免读者误读
- 锚定段落放在硬规则首次集中出现处,文中其他 4-5 处提及该规则可被前置覆盖
...
**修复成功示例**(evisa-application-guide-2026 patch 后):
"Resolution No. 389/NQ-CP on supplementing the list of international 
border gates allowing foreigners to enter and exit by electronic visas, 
dated 2 December 2025 and effective from its signing date, supplemented 
the e-visa checkpoint list."
