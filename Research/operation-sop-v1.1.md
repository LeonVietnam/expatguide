...
```
按 SOP v2.3 Prompt 1 的格式,帮我生成 10 个普通车道选题提案。
...
```
按 SOP v2.3 Prompt 1 的格式,帮我生成 1 个选题提案(不是 10 个选项)。
...
- Prompt 4 用 SOP v2.3 的 Deep Draft Prompt(不是普通 Prompt 4)
